...
<template>
	<div>
		...
		<div class="bannerBox">
			...
			<countdownc id="fixedCount" class="positionCount" @endCallback="endUpdata" :class="{'isFixed': winscoHeight}" :endDate="data.endTime" :startDate="data.startTime" :serverTime="serverTime"></countdownc>
		</div>
